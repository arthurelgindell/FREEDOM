...
-- Updated for LM Studio nomic-embed-text-v1.5 (768 dimensions)
-- 16.2x faster than OpenAI embeddings
...
CREATE TABLE IF NOT EXISTS document_chunks (
    ...
    -- Vector embeddings
    dense_vector vector(768),  -- LM Studio nomic-embed-text-v1.5 embeddings
...
CREATE TABLE IF NOT EXISTS rag_context_cache (
    ...
    embedding_vector vector(768),  -- Updated to 768 dimensions
...
-- Grant permissions
GRANT ALL ON ALL TABLES IN SCHEMA public TO freedom;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO freedom;